...
###### (Theorem):
$\lambda \in \mathbb{R}$ is an eigenvalue of $A \in \mathbb{R}^{n\times n}$ if and only if $\lambda$ is a root of the characteristic polynomial $p_A(λ)$ of $A$. ref: [Characteristic Polynomial](/notes/characteristic-polynomial/)
...
Due to [Angles and Orthogonality](/notes/angles-and-orthogonality/#orthogonal-matrix), this leads to a supercharged decomposition of the form $PDP^T$ (since $P^{-1}=P^T$).
###### (Theorem)
...
##### Connections
* Forward Links: [Eigendecomposition and Diagonalization](/notes/eigendecomposition-and-diagonalization/)
* Backward Links: [Determinant](/notes/determinant/), [Trace](/notes/trace/), [Characteristic Polynomial](/notes/characteristic-polynomial/), [Angles and Orthogonality](/notes/angles-and-orthogonality/), [Matrix decomposition landscape](/notes/matrix-decomposition-landscape/), [Symmetric, Positive Definite Matrices](/notes/symmetric-positive-definite-matrices/)
