...
##### Core Idea
Recall from [Column View of a System of Linear Equations](/notes/column-view-of-a-system-of-linear-equations/#extension) that a general system of linear equations can be represented as $\boldsymbol{A}\boldsymbol{x}=\boldsymbol{b}$. Here, $\boldsymbol{x}$ could be viewed as a vector that gets *transformed* to $\boldsymbol{b}$ using the matrix $\boldsymbol{A}$.
...
## Connections
* Forward Links: [Row View of a System of Linear Equations](/notes/row-view-of-a-system-of-linear-equations/), [Column View of a System of Linear Equations](/notes/column-view-of-a-system-of-linear-equations/)
* Backward Links: [System of Linear Equations](/notes/system-of-linear-equations/), [Matrix](/notes/matrix/)
## References
