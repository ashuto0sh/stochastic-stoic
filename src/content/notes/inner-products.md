...
##### Connections
* Forward Links: [Symmetric, Positive Definite Matrices](/notes/symmetric-positive-definite-matrices/), [Inner Product of Functions](/notes/inner-product-of-functions/)
* Backward Links: [Norms](/notes/norms/)
