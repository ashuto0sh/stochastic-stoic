...
Rotations exhibit a number of useful properties, which can be derived by considering them as orthogonal matrices ([Angles and Orthogonality](/notes/angles-and-orthogonality/#orthogonal-matrix)): 
...
##### Connections
* Forward Links:
* Backward Links: [Angles and Orthogonality](/notes/angles-and-orthogonality/), [Matrices as Linear Transformation](/notes/matrices-as-linear-transformation/)
