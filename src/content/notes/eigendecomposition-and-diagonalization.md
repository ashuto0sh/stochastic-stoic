...
## Connections
* Forward Links: [Singular Value Decomposition](/notes/singular-value-decomposition/)
* Backward Links: [Matrix decomposition landscape](/notes/matrix-decomposition-landscape/), [Eigenvalues and eigenvectors](/notes/eigenvalues-and-eigenvectors/), [Determinant](/notes/determinant/), [Matrix Representation of Linear Mappings](/notes/matrix-representation-of-linear-mappings/)
