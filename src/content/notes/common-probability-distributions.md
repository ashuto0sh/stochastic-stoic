...
##### Connections
* Forward Links: [Covariance Matrix](/notes/covariance-matrix/), [MLE and MAP](/notes/mle-and-map/), [Law of Large Numbers and Central Limit Theorem](/notes/law-of-large-numbers-and-central-limit-theorem/)
* Backward Links: [Random Variables](/notes/random-variables/), [Expectation and Variance](/notes/expectation-and-variance/)
