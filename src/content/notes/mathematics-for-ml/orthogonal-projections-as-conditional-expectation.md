...
Because random variables form a Hilbert space (see [Geometry of Random Variables](/notes/mathematics-for-ml/geometry-of-random-variables/)), we can view this purely geometrically.
...
##### Connections
* Forward Links: 
* Backward Links: [Orthogonal Projections](/notes/mathematics-for-ml/orthogonal-projections/), [Expectation and Variance](/notes/mathematics-for-ml/expectation-and-variance/), [Conditional Probability](/notes/mathematics-for-ml/conditional-probability/), [Geometry of Random Variables](/notes/mathematics-for-ml/geometry-of-random-variables/)
