...
##### Formal
The generalization of [Univariate Calculus Refresher](/notes/mathematics-for-ml/univariate-calculus-refresher/#derivative) to functions of several variables is the *gradient*.
###### (Partial Derivative)
...
##### Connections
* Forward Links:
* Backward Links: [Univariate Calculus Refresher](/notes/mathematics-for-ml/univariate-calculus-refresher/)
