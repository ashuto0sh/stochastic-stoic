...
##### Connections
* Forward Links:
* Backward Links: [Bayes Theorem](/notes/bayes-theorem/), [Common Probability Distributions](/notes/common-probability-distributions/), [Covariance Matrix](/notes/covariance-matrix/)
