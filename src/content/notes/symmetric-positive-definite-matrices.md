...
##### Connections
* Forward Links: [Cholesky Decomposition](/notes/cholesky-decomposition/), [Eigenvalues and eigenvectors](/notes/eigenvalues-and-eigenvectors/)
* Backward Links: [Inner Products](/notes/inner-products/), [Matrix](/notes/matrix/)
