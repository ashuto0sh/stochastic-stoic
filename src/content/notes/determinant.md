...
2. [Gaussian Elimination](/notes/gaussian-elimination/#gaussian-elimination) can be used to convert any matrix to triangular form (REF).
##### Connections
* Forward Links: [Trace](/notes/trace/), [Characteristic Polynomial](/notes/characteristic-polynomial/)
* Backward Links: [Matrix](/notes/matrix/), [Inverse and Transpose](/notes/inverse-and-transpose/#inverse), [Gaussian Elimination](/notes/gaussian-elimination/)
